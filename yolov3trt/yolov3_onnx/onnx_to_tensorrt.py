...
def main():
    ...
    onnx_file_path = '../../weights/last.onnx'
    engine_file_path = "../../weights/yolov5.trt"
    ...
    input_resolution_yolov3_HW = (384, 640)
    ...
    output_shapes = [(1, 102, 12, 20), (1, 102, 24, 40), (1, 102, 48, 80)]
